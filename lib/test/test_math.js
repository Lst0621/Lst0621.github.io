...
export function test_generate_general_linear_group_zn_m() {
    ...
    let gl_z2_2_to_group = generate_group(gl_2_z2, (a, b) => matrix_multiply_zn(a, b, 2), array_eq_2d, 20);
    ...
    let gl_3_z2_to_group = generate_group(gl_3_z2, (a, b) => matrix_multiply_zn(a, b, 2), array_eq_2d, 1000);
    ...
    let gl_2_z3_to_group = generate_group(gl_2_z3, (a, b) => matrix_multiply_zn(a, b, 3), array_eq_2d, 1000);
