import { array_eq, array_eq_2d, cartesian_product, complex_multiply, gen_general_linear_n_zm, generate_group, get_add_inverse_mod_n_function, get_add_mod_n_function, get_inverse, get_mul_inverse_mod_n_function, get_multiply_mod_n_function, inner_product, matrix_multiply_number, matrix_multiply_zn } from "../tsl/math.js";
...
export function test_generate_general_linear_group_zn_m() {
    ...
    for (let i = 0; i < gl_2_z3.length; ++i) {
        let mat = gl_2_z3[i];
        let inv = get_inverse(mat, get_add_mod_n_function(3), get_multiply_mod_n_function(3), get_add_inverse_mod_n_function(3), get_mul_inverse_mod_n_function(3));
