import { dihedral_multiply, dihedral_to_permutation, dihedral_to_str, get_all_dihedral, get_permutation_parity, perm_to_str, permutation_multiply } from "./tsl/math.js";
...
export function update_table(sz) {
    ...
    draw_multiplication_table(table, dihedrals, (a, b) => dihedral_multiply(a, b, sz), dihedral_to_str, (a) => "lightblue", (a, b, c) => "lightgreen");
