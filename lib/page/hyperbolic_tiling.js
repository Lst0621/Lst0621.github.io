...
function draw_geodesic_polygon(ctx, vertices, color, disk_center, disk_radius) {
    ctx.beginPath();
...
function calculate_hyperbolic_radius(p, q, disk_radius) {
...
export function draw_hyperbolic_square_with_neighbors(canvasId) {
