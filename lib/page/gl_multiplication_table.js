...
export function update_table() {
    ...
    let gl = gen_general_linear_zn_m_by_m(n, m);
    console.log(gl[0]);
    draw_multiplication_table(table, gl, (a, b) => matrix_multiply_zn(a, b, n), matrix_to_cell, always("lightblue"), always("lightyellow"));
}
