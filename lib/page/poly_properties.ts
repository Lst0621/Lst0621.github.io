import {poly_eval, poly_to_html, poly_to_latex_high_to_low, poly_to_latex_low_to_high} from "../tsl/ts/math/polynomial";
import {gen_prime} from "../tsl/ts/math/number";
import {range} from "../tsl/ts/util";
import {clear_table, draw_table} from "../tsl/ts/visual";
