import {test_cartesian_product, test_inner_product, test_matrix_multiply} from "../test/test_math.js";
...
export function update_table() {
    ...
    let tests = [test_matrix_multiply, test_cartesian_product, test_inner_product]
