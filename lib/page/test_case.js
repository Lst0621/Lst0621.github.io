import { test_cartesian_product, test_complex_numbers, test_generate_general_linear_group_zn_m, test_inner_product, test_matrix_add, test_matrix_multiply, test_mod } from "../test/test_math.js";
...
export function update_table() {
    ...
    let tests = [test_matrix_multiply, test_matrix_add, test_cartesian_product, test_inner_product, test_mod, test_generate_general_linear_group_zn_m, test_complex_numbers];
