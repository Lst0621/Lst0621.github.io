...
export function draw() {
    ...
    let columns_text = ["subtotal", "tax", "total",
    ...
    draw_table(tip_table, tips, columns_text, get_element, (x) => x.toString() + "%", x => x, x => x.toFixed(2).toString(), always("lightgreen"), always("yellow"), always("pink"));
}
