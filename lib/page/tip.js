...
export function draw() {
    ...
    let columns_text = ["food", "tax", "food+tax",
    ...
    draw_table(tip_table, tips, columns_text, get_element, (x) => x.toString() + "%", x => x, x => x.toFixed(2).toString(), (row) => (row % 2 == 0 ? "lightgreen" : "white"), always("lightyellow"), (row, col) => row % 2 == 0 ? "lightblue" : "white");
}
