import { concat_same_string_lists_leq_n_times, get_all_prefixes, get_alphabet_from_strings, get_regex_for_disallowed_sub_seq, sub_empty_with_ep } from "../tsl/lang/string.js";
...
function init() {
    let init_subs = "abcda,bacbb,accb";
    // init_subs = "abc,cba";
...
function update() {
    ...
    draw_table(table, all_states, alphabet, (row, col) => {
