...
function add_groups(years2) {
  years2.sort((a, b) => b - a);
  for (let year = 0; year < years2.length; year++) {
    add_year_month(years2[year]);
  }
}
function clear_groups(years2) {
  for (let year = 0; year < years2.length; year++) {
    remove_empty_year_month(years2[year]);
  }
}
function clean_up() {
...
var MATH_TAGS = /* @__PURE__ */ new Set([
  "Algebra",
  "Logic",
  "Set",
  "Analysis",
...
// lib/page/library_of_hj.ts
update_from_file("../../resource/lib_of_hj.psv");
