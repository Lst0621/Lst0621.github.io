// tsl/wasm/ts/wasm_api_graph_demo.ts
import wasmGraph from "../tsl/wasm/wasm_out_v1/wasm_graph.js";
...
function renderResolvingSubsetsPanel(modeName, pageIndex, res) {
  ...
  const smallestLine = `Min dimension (${modeName}): ${res.minDimension}<br>Smallest set: ${smallest}<br>`;
